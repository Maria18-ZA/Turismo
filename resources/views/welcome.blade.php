...
<a href="{{ route('user.hoteis.index') }}" class="text-white/85 text-sm font-medium border-b-2 border-transparent hover:text-acento hover:border-acento transition-all duration-200">Hotéis</a>
    ...
    <a href="#" class="text-white/85 text-sm font-medium border-b-2 border-transparent hover:text-acento hover:border-acento transition-all duration-200">Cultura</a>
</nav>
</header>
...
<div class="flex gap-6 overflow-x-auto pb-4 w-100">
