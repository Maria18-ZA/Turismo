...
<div class="max-w-2xl mx-auto mt-10">
    <h1 class="text-2xl text-center font-bold text-texto-escuro mb-6"> Novo Serviço</h1>
    ...
    <form action="{{ route('servicos.store') }}" method="POST">
        @csrf
            ...
            <select name="tipo" id="tipo" class="min-w-sm border border-borda-card rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primaria">
            ...
            <select name="hotel_id" id="hotel_id" class="min-w-sm border border-borda-card rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primaria">
